...
exec sudo --preserve-env=RUST_LOG -g obscura bash -c "umask 0007 && exec ./result-linux/target-$TARGET_ARCH/cli/debug/obscura service --config-dir /var/lib/obscura --log-dir /var/log/obscura"
