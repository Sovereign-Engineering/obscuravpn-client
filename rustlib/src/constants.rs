...
pub const DEFAULT_API_IP_SEED: IpAddr = IpAddr::V4(Ipv4Addr::new(66, 42, 95, 12));
pub const DNS_CACHE_SEED: &[(&str, &[SocketAddr])] = &[(DEFAULT_API_DOMAIN, &[SocketAddr::new(DEFAULT_API_IP_SEED, 0)])];
